...
export default function FraudDetectionAgent() {
  const [transactions, setTransactions] = useState(() => generateTransactions(120));
  ...
  const reset = () => {
    ...
    setRunning(false);
    setCursor(0);
    setTransactions(generateTransactions(120));
  ...
  return (
    <div style={{
      ...
      {/* Enhanced Header */}
      <div style={{
        background: darkMode ? "linear-gradient(135deg, #0f172a 0%, #1e1b4b 100%)" : "linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)",
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <span style={{ fontSize: 20, fontWeight: 800, letterSpacing: "-0.02em", color: darkMode ? "#f1f5f9" : "#fff" }}>
              FRAUD<span style={{ color: "#22d3ee" }}>GUARD</span>
            </span>
            <span style={{
              background: darkMode ? "#1e293b" : "rgba(255,255,255,0.2)", color: darkMode ? "#64748b" : "#fff",
              fontSize: 10, padding: "2px 8px", borderRadius: 4, letterSpacing: "0.1em",
            }}>AI AGENT v2.1</span>
          </div>
          <div style={{ fontSize: 11, color: darkMode ? "#475569" : "rgba(255,255,255,0.7)", marginTop: 4 }}>
        ...
        <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
          <button
            ...
            style={{
              background: darkMode ? "#1e293b" : "rgba(255,255,255,0.2)",
              border: darkMode ? "1px solid #334155" : "1px solid rgba(255,255,255,0.3)",
              color: darkMode ? "#94a3b8" : "#fff", padding: "8px", borderRadius: 6,
          ...
          <select
            ...
            style={{
              background: darkMode ? "#1e293b" : "rgba(255,255,255,0.2)",
              border: darkMode ? "1px solid #334155" : "1px solid rgba(255,255,255,0.3)",
              color: darkMode ? "#94a3b8" : "#fff", padding: "6px 12px", borderRadius: 6,
          ...
          <button onClick={reset} style={{
            background: darkMode ? "#1e293b" : "rgba(255,255,255,0.2)",
            border: darkMode ? "1px solid #334155" : "1px solid rgba(255,255,255,0.3)",
            color: darkMode ? "#94a3b8" : "#fff", padding: "8px 16px", borderRadius: 6,
          ...
          <button onClick={runAgent} disabled={running || cursor >= transactions.length} style={{
            background: running ? (darkMode ? "#1e293b" : "rgba(255,255,255,0.3)") : "linear-gradient(135deg, #6366f1, #8b5cf6)",
            border: "none", color: running ? (darkMode ? "#64748b" : "#fff") : "#fff",
      ...
      <div style={{ padding: "24px 32px" }}>
        ...
        {activeTab === "dashboard" && (
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            {/* Metrics Gauges */}
            <div style={{
              background: "#0f172a", border: "1px solid #1e293b", borderRadius: 12, padding: 24,
            }}>
              ...
              {metrics ? (
                <div>
                  <div style={{ display: "grid", gridTemplateColumns: "80px 1fr 1fr", gap: 8, fontSize: 11 }}>
                    ...
                    <div style={{
                      background: "#14532d55", border: "1px solid #22c55e44",
                      borderRadius: 8, padding: "20px 0", textAlign: "center",
                    }}>
                      <div style={{ fontSize: 28, fontWeight: 800, color: "#34d399" }}>{metrics.tp}</div>
                      <div style={{ fontSize: 10, color: "#16a34a" }}>True Positive</div>
                    </div>
                    <div style={{
                      background: "#7f1d1d55", border: "1px solid #ef444444",
                      borderRadius: 8, padding: "20px 0", textAlign: "center",
                    }}>
                      <div style={{ fontSize: 28, fontWeight: 800, color: "#f87171" }}>{metrics.fn}</div>
                      <div style={{ fontSize: 10, color: "#dc2626" }}>False Negative</div>
                    </div>
                    ...
                    <div style={{
                      ...
                      <div style={{ fontSize: 28, fontWeight: 800, color: "#f87171" }}>{metrics.fp}</div>
                      <div style={{ fontSize: 10, color: "#dc2626" }}>False Positive</div>
                    </div>
                    <div style={{
                      background: "#1e1b4b55", border: "1px solid #6366f144",
                      borderRadius: 8, padding: "20px 0", textAlign: "center",
                    }}>
                      <div style={{ fontSize: 28, fontWeight: 800, color: "#818cf8" }}>{metrics.tn}</div>
                      <div style={{ fontSize: 10, color: "#6366f1" }}>True Negative</div>
                    </div>
                  </div>
                  <div style={{
                    marginTop: 20, padding: 14, background: "#1e293b", borderRadius: 8,
                    fontSize: 12, color: "#94a3b8", lineHeight: 1.7,
                  }}>
                    <strong style={{ color: "#f1f5f9" }}>Interpretation: </strong>
      ...
      <style>{`
        ...
        ::-webkit-scrollbar-thumb { background: ${darkMode ? '#334155' : '#cbd5e1'}; border-radius: 3px; }
